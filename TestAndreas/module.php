...
class TestAndreas extends IPSModule
{
    public function Create()
    {
        ...
        $this->CreateVarProfile('TA.Handy', IPS_BOOLEAN, '', 0, 0, 0, 0, 'Heart', $associations);
    }
    ...
    public function ApplyChanges()
    {
		...
		if ($device1 != '' && $user1 != '') {
               $ok1 = true;
			   $this->MaintainVariable("user1Active", $user1, IPS_BOOLEAN, "TA.Handy", 0, $this->ReadPropertyString('user1') != '');
               $this->SetStatus(102);
        } 
		else {
			 $ok1 = false;
